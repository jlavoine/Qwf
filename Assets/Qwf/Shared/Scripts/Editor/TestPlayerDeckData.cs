...
namespace Qwf {
    ...
    public class TestPlayerDeckData {
        ...
        public void CorrectListOfGamePieces_CreatedFromDeckData() {
            ...
            List<IServerGamePiece> pieces = data.GetListOfPiecesFromDeck( mockPlayer );
        ...
        private void MakeSurePiecesOfTypeAreInList( List<IServerGamePiece> i_pieces, int i_pieceType, int i_pieceValue, int i_pieceCount ) {
            int count = 0;

            foreach ( IServerGamePiece piece in i_pieces ) {
